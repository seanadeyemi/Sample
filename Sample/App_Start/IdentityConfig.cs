...
namespace Sample
{
    ...
    public class ApplicationUserManager : UserManager<SampleUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<SampleUser>(context.Get<SampleDbContext>()));
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<SampleUser>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
    ...
    public class ApplicationSignInManager : SignInManager<SampleUser, string>
    {
        ...
        public override Task<ClaimsIdentity> CreateUserIdentityAsync(SampleUser user)
        {
